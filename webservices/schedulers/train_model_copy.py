...
from preprocess_wiki_content_copy import PrepareModelDatasetCopy

dataset_obj = PrepareModelDatasetCopy()
...
class TrainModel():
    def __init__(self):
        self.n_splits = 5
        self.model_name = '/mnt/data1/imai_phase_4new/model_files/20240726_100822/5/checkpoint-570'
    ...
    def train_evaluate_model(self, hf_dataset, model, tokenizer, n_splits, common_training_args, timestamp):
        ...
        for fold, (train_idx, val_idx) in enumerate(kf.split(hf_dataset)):
            ...
            training_args = TrainingArguments(
                output_dir=f"{model_save_path}/{timestamp}test/{fold+1}",
