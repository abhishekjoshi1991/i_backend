...
# n_gpu_layers = 25  # The number of layers to put on the GPU. The rest will be on the CPU. If you don't know how many layers there are, you can use -1 to move all to GPU.
# n_batch = 512  # Should be between 1 and n_ctx, consider the amount of VRAM in your GPU.

# # Make sure the model path is correct for your system!
# llm = LlamaCpp(
#     model_path="/mnt/data1/hf_cache/Phi-3-mini-4k-instruct-q4.gguf",
...
#     n_ctx=4096,
#     n_threads=8,
#     n_gpu_layers=35  # Set to 0 if no GPU acceleration is available
# )

# # Wrap the Llama object in a LangChain compatible format
# llm = LlamaCpp(
#     model_path='/mnt/data1/hf_cache/Phi-3-mini-4k-instruct-q4.gguf',
#     n_ctx=4096,
#     n_threads=8,
...
#     verbose=False,
#     _llama_cpp_obj=llm_base  # Use the pre-initialized Llama object
# )
...
class GetModelTokenizer:
    def __init__(self):
        ...
        # with fine tuned previously trained model on feedback records of 5
        # self.model_path = "/mnt/data1/imai_phase_4new/model_files/20240816_112928test/5/checkpoint-16"
